...
namespace perfume.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,MessageText")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,MessageText")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
